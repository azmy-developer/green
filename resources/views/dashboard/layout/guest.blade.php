...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('dash/app-assets/css-rtl/plugins/forms/form-validation.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('dash/app-assets/css-rtl/pages/authentication.css')}}">
    <!-- END: Page CSS-->
...
<!-- BEGIN: Page JS-->
<script src="{{asset('dash/app-assets/js/scripts/pages/auth-login.js')}}"></script>
<!-- END: Page JS-->
